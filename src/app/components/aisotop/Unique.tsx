...
export function Unique() {
  return (
    <Section id="unique" className="py-24">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="space-y-12">
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <h2 className="text-6xl md:text-7xl font-black text-foreground leading-[0.9] tracking-tighter">
                What Makes <br />
                <span className="text-primary">AISOTOP</span> <br />
                <span className="text-foreground italic">Unique</span>
              </h2>
            </div>
        ...
        {/* Right Column: Image */}
        <div className="group relative aspect-[4/5] w-full rounded-[3.5rem] overflow-hidden border border-foreground/10 bg-foreground/5 shadow-[0_0_50px_rgba(0,0,0,0.2)]">
          <ImageWithFallback
            src={whyAisotopImg}
          ...
          <div className="absolute bottom-10 left-10 right-10 space-y-2">
            ...
            <div className="text-foreground text-2xl font-black tracking-tighter uppercase leading-tight">
